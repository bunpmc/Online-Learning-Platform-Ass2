...
public class DatabaseSeedService
{
    ...
    {
        var userRole = await _context.Roles.FirstOrDefaultAsync(r => r.Name == "Student" || r.Name == "User");
        if (userRole == null) return; // Skip if no role found
        
        // Create sample user if none exist
        if (!await _context.Users.AnyAsync(u => u.Role != null && (u.Role.Name == "User" || u.Role.Name == "Student")))
        {
